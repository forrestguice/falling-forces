...
public class GLText
{
   ...
   public boolean load(String family, int style, int size, int padX, int padY)
   {
   ...
   //--Draw Text Right--//
   public float drawR(String text, float x, float y) 
   {
      float len = getLength( text );                  // Get Text Length
      draw( text, x - len, y);  // Draw Text Centered
      return len;                                     // Return Length
   }
