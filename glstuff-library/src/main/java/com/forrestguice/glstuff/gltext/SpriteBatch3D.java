...
public class SpriteBatch3D {
   ...
   //--Constants--//
   final static int VERTEX_SIZE = 4;                  // Vertex Size (in Components) ie. (X,Y,Z,U,V)
   ...
   public SpriteBatch3D(GL10 gl, int maxSprites)  
   {
   ...
   public void drawSprite(float x, float y, float z, float width, float height, TextureRegion region)  
   {
      ...
      //System.out.println("(" + x2 + "," + y2 + "," + z + ")");
      //System.out.println("(" + x1 + "," + y2 + "," + z + ")");
